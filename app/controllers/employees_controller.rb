...
class EmployeesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @employee.save
        format.html { redirect_to employee_url(@employee), notice: I18n.t('es.created', record: @employee) }
  ...
  def update
    respond_to do |format|
      if @employee.update(employee_params)
        format.html { redirect_to employee_url(@employee), notice: I18n.t('es.updated', record: @employee) }
